...
for file_idx = 1 : length(L_mn0_values)
    ...
    fileName = [num2str(L_mn0_values(file_idx)) '_' num2str(u0) '_sol_YB_wod_bF_passive_DEq.mat'];
...
for file_idx = 1 : length(L_mn0_values)
    ...
    fileName = [num2str(L_mn0_values(file_idx)) '_' num2str(u0) '_sol_YB_wod_aF_passive_DEq.mat'];
